...
let favoriteFoods = ['pizza', 'lasagna', 'bariis', 'burrito']
console.log('fav foods are: ', favoriteFoods);
...
favoriteFoods.push('Mac and Cheese');
console.log('Added new food to end,', favoriteFoods);
...
console.log(`Added a new food to beginning: ${favoriteFoods}`);
...
console.log('Removed the first food', favoriteFoods);
console.log('The foods are now', favoriteFoods);
...
console.log ('replaced favorite food', favoriteFoods);
...
favoriteFoodsString = favoriteFoods.join (' and ');
...
favoriteFoods = ['sushi', 'pizza', 'burrito', 'bariis'];
